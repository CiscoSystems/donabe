...
To start the Donabe service, first initialise the database with the folling commands:
...
Alternatively Doanbe can be run in daemon mosde using:
...
== The Recursive container format

To be written.

== Using Donabe via REST API
